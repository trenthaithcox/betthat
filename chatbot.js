...
window.addEventListener('load', function() {
    ...
    try {
        ...
        toggle.style.cssText = 'position:fixed; bottom:20px; right:20px; width:70px; height:70px; border-radius:50%; background-color:#4096FF; color:white; display:flex; align-items:center; justify-content:center; cursor:pointer; box-shadow:0 5px 15px rgba(0,0,0,0.2); z-index:1000; animation: pulse-attention 2s infinite;';
        ...
        style.textContent = `
            @keyframes pulse-attention {
                ...
                50% { transform: scale(1.05); box-shadow: 0 5px 20px rgba(64,150,255,0.4); }
